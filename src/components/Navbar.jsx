            ...
            {dropdownOpen && (
              <div className="nav-dropdown">
                ...
                {userData?.role === "creator" ? (
                  <Link to="/creator-dashboard" className="dd-item">Creator Dashboard</Link>
                ) : (
                  <Link to="/business-dashboard" className="dd-item">Business Dashboard</Link>
                )}
                ...
                <button onClick={logout} className="dd-item logout">Log Out</button>
